...
class PAdmin(tk.Tk):
    def __init__(self, name="", username="", email=""):
        ...
        self.userimg = utl.leer_imagen(r"C:\\Users\\DIEGO YEPES\\Desktop\\appactividad2\\\app\\imagenes\\userinfo.png", (128,128))
        self.imgfacebook = utl.leer_imagen(r"C:\\Users\\DIEGO YEPES\\Desktop\\appactividad2\\app\\imagenes\\face.png",(48,48))
        self.imglinkedin = utl.leer_imagen(r"C:\\Users\\DIEGO YEPES\\Desktop\\appactividad2\\app\\imagenes\\linkedin.png", (48,48))
        self.imgwebsite = utl.leer_imagen(r"C:\\Users\\DIEGO YEPES\\Desktop\\appactividad2\\app\\imagenes\\website.png", (48,48))
        self.imglogout = utl.leer_imagen(r"C:\\Users\\DIEGO YEPES\\Desktop\\appactividad2\\app\\imagenes\logout.png", (48,48))
        ...
        #Frame_Data
        self.frame_data = tk.Frame(self, bd=0, relief=tk.SOLID, width=f"{self.ancho_pantalla-200}", bg="green")
    ...
    def abrirwebsite(self):
        url= "https://github.com/Diegoprog07"
        webbrowser.open_new_tab(url)
    def logout(self):
        self.destroy()
